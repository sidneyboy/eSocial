                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="card" style="width: 100%;">
                                ...
                                <form action="{{ route('instructor_add_course_chapter_assignment_next_question') }}"
                                    method="get" enctype="multipart/form-data">
                                    @csrf
                                    <div class="card-body">
                                        <div class="form-group">
                                            <input type="hidden" name="count_variable"
                                                value="{{ $count_variable + 1 }}">
                                            ...
                                            <input type="hidden" value="{{ $question_type }}" name="question_type"
                                                id="question_type">
                                            <input type="hidden" name="next_count_variable"
                                                value="{{ $count_variable + 1 }}">
