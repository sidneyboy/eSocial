                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card" style="width: 100%;">
                                <div class="card-header" style="font-weight: bold;">
                                    @php
                                        echo $total_left = $count_variable . ' out of ' . $original_number_of_questions;
                                ...
                                <form action="{{ route('instructor_add_course_chapter_exam_next_question') }}"
                                    ...
                                    @csrf
                                    <div class="card-body">
                                        <input type="hidden" name="count_variable" value="{{ $count_variable + 1 }}">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="next_count_variable" value="{{ $count_variable+1 }}">
                                            <input type="hidden" value="{{ $original_number_of_questions }}"
                                                id="original_number_of_questions" name="original_number_of_questions">
                                        </div>
                                        <div id="show"></div>
                                    </div>
            ...
            if ($('#question_type').val() == 'Enumeration') {
                ...
                if (loop_number != null) {
                    ...
                    $.post({
                        ...
                        url: "/instructor_add_course_chapter_quiz_question_type",
                        data: 'question_type=' + question_type + '&loop_number=' + loop_number +
                            '&original_number_of_questions=' + original_number_of_questions,
                        success: function(data) {
                            $('#show').html(data);
                        },
                        error: function(error) {
                ...
                $.post({
                    type: "POST",
                    url: "/instructor_add_course_chapter_quiz_question_type",
                    data: 'question_type=' + question_type + '&original_number_of_questions=' +
