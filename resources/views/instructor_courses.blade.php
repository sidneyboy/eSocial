                    ...
                    <div class="card-body">
                        <ul class="list-group">
                            <li class="list-group-item">
                                ...
                                <!-- Modal -->
                                <div class="modal fade" id="exampleModal_add_subject_file{{ $data->id }}" tabindex="-1"
                            ...
                            @foreach ($data->course_details as $details)
                                ...
                                @if ($file_type == 'application')
                                    <li class="list-group-item">
                                        ...
                                        <button type="button" class="btn btn-primary btn-sm btn-block" data-toggle="modal"
                                            data-target="#exampleModal_pdf{{ $details->id }}">
                                            {{ $details->file }}
                                        </button>
                                ...
                                @elseif($file_type == 'image')
                                    <li class="list-group-item">
                                        <!-- Button trigger modal -->
                                        <button type="button" class="btn btn-primary btn-sm btn-block" data-toggle="modal"
                                            data-target="#exampleModal_image{{ $details->id }}">
                                            {{ $details->file }}
                                        </button>
