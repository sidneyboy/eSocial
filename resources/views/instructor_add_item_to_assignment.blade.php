    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card" style="width: 100%;">
                ...
                <form action="{{ route('instructor_add_course_chapter_assignment_next_question') }}" method="get"
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="hidden" value="{{ $assignment->course_chapter_id }}" name="course_chapter_id">
