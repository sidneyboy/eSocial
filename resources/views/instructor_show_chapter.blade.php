                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <button class="btn btn-info btn-sm btn-block" style="margin-bottom: 10px;"
                                            type="button" data-toggle="collapse"
                                            data-target="#collapseExampleexam{{ $data->id }}" aria-expanded="false"
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <div class="modal fade"
                                                                        id="exampleModal{{ $quiz->id }}" tabindex="-1"
                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6" style="margin-bottom: 10px;">
                                ...
                                <!-- Modal -->
                                <div class="modal fade" id="exampleModalcontent{{ $data->id }}" tabindex="-1"
