...
@section('main-content')
    ...
    <form action="{{ route('instructor_edit_assignment_question_process') }}" method="post">
        @csrf
            ...
            <div class="card-body">
                ...
                @elseif($question->question_type == 'Multitple Choice')
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">
                            A.
                            <input type="text" name="choice_a" value="{{ $question->assignment_details->choice_a }}" required
                                class="form-control">
                        </li>
                        <li class="list-group-item">
                            B.
                            <input type="text" name="choice_b" value="{{ $question->assignment_details->choice_b }}" required
                                class="form-control">
                        </li>
                        <li class="list-group-item">
                            C.
                            <input type="text" name="choice_c" value="{{ $question->assignment_details->choice_c }}" required
                                class="form-control">
                        </li>
                        <li class="list-group-item">
                            D.
                            <input type="text" name="choice_d" value="{{ $question->assignment_details->choice_d }}" required
                                class="form-control">
                        </li>
                    </ul>
                    <input type="hidden" name="quiz_details_id" value="{{ $question->assignment_details->id }}">
